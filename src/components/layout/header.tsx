        ...
        {user ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-8 bg-black/70 px-2 text-white hover:bg-black/90">
                <Avatar className="h-6 w-6">
                  <AvatarImage src={'/images/user-avatar.webp'} alt={user.name} />
            ...
            <DropdownMenuContent align="end" className="w-56 border-gray-700 bg-gray-800">
              ...
              <DropdownMenuItem className="text-gray-300 focus:bg-gray-700 focus:text-white" onClick={onLogout}>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button className="bg-white text-black hover:bg-gray-200">Iniciar sesión</Button>
          </div>
        )}
      </div>
    </header>
